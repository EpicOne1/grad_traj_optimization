...
private:
  ...
  /* state propagation */
  void stateTransit(Eigen::Matrix<double, 6, 1>& state0, Eigen::Matrix<double, 6, 1>& state1, Eigen::Vector3d um,
                    double tau);
...
public:
  ...
  void getKinoTrajMat(Eigen::MatrixXd& Pos, Eigen::MatrixXd& Vel, Eigen::MatrixXd& Acc,
                                        Eigen::VectorXd& Time);
